...
class Plotter:
    ...
    def create_path_animation(self):
        ...
        globals()['var_hold_pos'] = plt.Circle((0,0), config.rad_hold, color='g', linestyle='--', label="Varying Holding Radius")
        ...
        goal, = ax.plot(self.mpc.data['_tvp', 'x_target'][0], self.mpc.data['_tvp', 'y_target'][0], marker="x", color='g', markersize=10, label="Goal", zorder=0)
        ...
        # animation.save('images/path_animation.gif', writer=ImageMagickWriter(fps=3))
        plt.show()
